    ...
    with st.spinner("Fetching Astronomy Picture of the Day..."):
        try:
            ...
            if media_type == "image":
                ...
                st.warning("⚠️ The media type for this day is not supported.")
...
with tab2:
    ...
    if not df_asteroids.empty and "Diameter (m)" in df_asteroids.columns:
        ...
        st.warning("⚠️ No asteroid data available today.")
